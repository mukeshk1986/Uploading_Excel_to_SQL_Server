...
schemaTest = qrs.sql_db_settings['SAGE_Test_DBNAME'] #commented by Mukesh
...
for (ws,tn)  in ws_tn_dict.items():
    ...
    print('{} seconds: completed {} '.format((dt.datetime.now() - today).seconds, ws))
